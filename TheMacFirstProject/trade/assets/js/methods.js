...
if (typeof localStorage === 'object') {
    ...
    try {
        ...
        Storage.prototype.setItem = function() {
            ...
            alert(Alicms.L('localStorage功能无法正常使用，请检查浏览器设置。'));
...
define([md5, jsencrypt, juabox], function (MD5, JSEncrypt, JuaBox) {
    ...
    var Methods = {
            ...
            options.error = options.error || function (res) {
                ...
                switch (resMsg.code) {
                    ...
                    case 1003:
                        ...
                        JuaBox.showWrong(Alicms.L(resMsg.message));
        ...
        setCookie: function (name, value, days) {
            ...
            document.cookie = name + "=" + value + expires + ";domain=.Alicms.com; path=/";
